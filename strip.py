...
def strip_finder(data, ang_rad, nside):
	...
	ipix_strip1 = hp.query_strip(NSIDE, ang_rad-(2*np.pi/360), ang_rad+(2*np.pi/360))
	ipix_strip2 = hp.query_strip(NSIDE, np.pi-ang_rad-(2*np.pi/360), np.pi-ang_rad+(2*np.pi/360))
